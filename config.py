...
MONGO_DB = getenv("MONGO_DB", "mongodb+srv://Zaid:Zaid@cluster0.4bszo.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
ALIVE_IMG = getenv("ALIVE_IMG", "https://telegra.ph/file/60af4b8b00bd712e20286.jpg")
DB_URL = getenv("DATABASE_URL", "postgres://xwmrxzbc:yNA7EcgVuQoN518ZqB0VMKwzKDbS1jhF@jelani.db.elephantsql.com/xwmrxzbc")
